...
from .views import prever_gasto, gastos, gasto_detail, dashboard, receitas, receita_detail, exportar_csv, exportar_xlsx, exportar_pdf, listar_metas, criar_meta, atualizar_meta, deletar_meta, extrato, FlushUsersView
...
urlpatterns = [
    ...
    path("admin/flush-users/", FlushUsersView.as_view(), name="flush_users"),
