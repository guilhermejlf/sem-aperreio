...
class FamilyDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Family
        fields = ['id', 'name', 'code', 'code_expires_at', 'created_by', 'created_at', 'members', 'member_count', 'user_role']
        read_only_fields = ['id', 'code', 'code_expires_at', 'created_by', 'created_at', 'members', 'member_count', 'user_role']
    ...
    def get_user_role(self, obj):
        ...
        if request and hasattr(request.user, 'membership'):
            return request.user.membership.role
        return None
