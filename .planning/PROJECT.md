...
- Options API no Vue → **Migração em andamento 2026-05-29** — Fase 1+2: 9 componentes leaf migrados (AppLoading, BeneAvatar, SkeletonGeneric, StatementGroup, SkeletonSettings, SkeletonProfile, SkeletonDashboard, StatementEmptyState, BeneInsight). usePagination composable criado. Restam ~40 componentes.
